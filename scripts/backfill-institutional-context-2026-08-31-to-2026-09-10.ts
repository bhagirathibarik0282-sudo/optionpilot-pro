...
const rows = [
  { d:"2026-08-31", fb:60025.88, fs:68011.76, fn:-7985.88, db:19730.38, ds:15141.50, dn:4588.88, nifty:24080.40, niftyPct:-0.39, callCh:4558, putCh:-42953, callNet:-225000, putNet:551000, futCh:-6682, futNet:-209000 },
  { d:"2026-09-01", fb:17807.53, fs:16664.15, fn:1143.38, db:15635.49, ds:13788.55, dn:1846.94, nifty:24055.80, niftyPct:-0.10, callCh:-22599, putCh:81058, callNet:-248000, putNet:632000, futCh:-12717, futNet:-222000 },
  { d:"2026-09-02", fb:26715.88, fs:20027.51, fn:6688.37, db:17639.89, ds:14826.91, dn:2812.98, nifty:23914.45, niftyPct:-0.59, callCh:-51192, putCh:-39242, callNet:-299000, putNet:593000, futCh:-7131, futNet:-229000 },
  { d:"2026-09-03", fb:13596.04, fs:15941.91, fn:-2345.87, db:17063.65, ds:12086.19, dn:4977.46, nifty:23873.45, niftyPct:-0.17, callCh:-12954, putCh:56826, callNet:-312000, putNet:650000, futCh:-5939, futNet:-235000 },
  { d:"2026-09-04", fb:13857.58, fs:16969.52, fn:-3111.94, db:19254.19, ds:10324.07, dn:8930.12, nifty:23897.70, niftyPct:0.10, callCh:8753, putCh:-69138, callNet:-303000, putNet:581000, futCh:-736, futNet:-236000 },
  { d:"2026-09-07", fb:9581.19, fs:9301.06, fn:280.13, db:13154.13, ds:12587.37, dn:566.76, nifty:23779.15, niftyPct:-0.50, callCh:5352, putCh:50236, callNet:-298000, putNet:631000, futCh:-14255, futNet:-250000 },
  { d:"2026-09-08", fb:11704.84, fs:11828.03, fn:-123.19, db:14678.53, ds:13328.89, dn:1349.64, nifty:23635.10, niftyPct:-0.61, callCh:-3980, putCh:19498, callNet:-302000, putNet:651000, futCh:-11464, futNet:-262000 },
  { d:"2026-09-09", fb:16392.90, fs:16975.89, fn:-582.99, db:18130.76, ds:16621.72, dn:1509.04, nifty:23431.50, niftyPct:-0.86, callCh:-40561, putCh:9607, callNet:-343000, putNet:660000, futCh:-14693, futNet:-276000 },
  { d:"2026-09-10", fb:11882.95, fs:12321.19, fn:-438.24, db:13326.33, ds:12300.48, dn:1025.85, nifty:23477.80, niftyPct:0.20, callCh:23772, putCh:2512, callNet:-319000, putNet:663000, futCh:-5594, futNet:-282000 },
];
...
async function main() {
  ...
  try {
    ...
    for (const r of rows) {
      await pool.query(`
        INSERT INTO institutional_daily_context (
          trade_date, cash_source, cash_source_url,
        ...
        ON CONFLICT (trade_date) DO UPDATE SET
          ...
          updated_at=now()
      `, [
        r.d, CASH_SOURCE, CASH_SOURCE_URL, DERIV_SOURCE, DERIV_SOURCE_URL, NSE_REPORTS_URL,
    ...
    const readback = await pool.query(`
      SELECT trade_date::text, fii_net, dii_net, fii_index_futures_net_position,
             fii_index_call_net_position, fii_index_put_net_position, derivative_behaviour
    ...
    console.log("[INSTITUTIONAL_BACKFILL] success", JSON.stringify({ rows: readback.rows, count: readback.rowCount }));
  } finally {
    await pool.end();
  }
}
