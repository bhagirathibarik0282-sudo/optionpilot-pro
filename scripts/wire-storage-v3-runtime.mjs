...
const PHASE46_IMPORT = 'import { persistPhase46ChainTruthFromExistingSnapshot } from "./phase46-runtime-metric-persist.js";';
...
if (!source.includes(PHASE46_IMPORT)) source = source.replace(IMPORT_MARKER, `${IMPORT_MARKER}\n${PHASE46_IMPORT}`);
if (!source.includes(HEALTH_IMPORT)) source = source.replace(PHASE46_IMPORT, `${PHASE46_IMPORT}\n${HEALTH_IMPORT}`);
