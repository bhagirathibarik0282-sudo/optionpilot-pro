...
if (!src.includes(MARKER)) {
  ...
  replaceOnce('            futureChange: null,', '            futureChange: prevFut && Number.isFinite(Number(prevFut?.ltp)) && Number.isFinite(Number(fut?.ltp)) ? Number(fut.ltp) - Number(prevFut.ltp) : null,', "business-flow futures change");
