...
<body>
  ...
  <script>
    ...
    const SUPPORTING_MODULES = ['Cross-Expiry ITM', 'ATM Straddle', 'PCR', 'Call Wall / Put Wall', 'Reversal Observation', 'Previous-Session Context'];
    ...
    function renderOrchestratorCard(symbol, m) {
      ...
      html += 'Support Coverage: ' + orch.supportReadyCount + '/6';
      html += '</div>';
