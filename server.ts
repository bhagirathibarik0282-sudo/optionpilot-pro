...
<body>
  ...
  <script>
    ...
    function renderOverviewTab(symbol, m) {
      ...
      html += '<div class="timestamp">Day open/high/low and first-15m range are not yet tracked, shown as DATA UNAVAILABLE. 15m/30m/1h trend uses this session\u2019s accumulated spot history — shows DATA UNAVAILABLE until enough history builds up (up to 1 hour after the dashboard is first opened each day).</div>';
      return html;
    }
