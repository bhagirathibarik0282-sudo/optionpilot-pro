...
<body>
  ...
  <script>
    ...
    function renderOptionsWallsPcr(symbol, m) {
      ...
      html += '<div class="timestamp">Wall candidates use only the max-OI strike within ATM \u00b12 (5 strikes) — not the spec\u2019s wider ATM \u00b110/\u00b120 scan, so this is a narrow approximation, not a confirmed resistance/support wall. Status (Building/Weakening/Stable) reflects OI direction only, not the full multi-factor confirmation the spec describes. Broken/Shifted states and previous-day wall comparison are not yet tracked.</div>';
      return html;
    }
