...
test("truth envelope is usable only with valid identity and fresh time", () => {
  const r = buildTruthEnvelope({
    expectedIdentity: identity,
    actualIdentity: { ...identity },
    sourceProvider: "KITE",
    sourceTimestamp: "2026-08-26T04:00:00.000Z",
    receivedAt: "2026-08-26T04:00:10.000Z",
    policy,
  });
...
test("fresh quote with wrong token remains blocked", () => {
  const r = buildTruthEnvelope({
    expectedIdentity: identity,
    actualIdentity: { ...identity, instrumentToken: "222" },
    sourceProvider: "KITE",
    sourceTimestamp: "2026-08-26T04:00:00.000Z",
    receivedAt: "2026-08-26T04:00:10.000Z",
    policy,
...
test("opening gap is stable conceptually while return-from-close follows current price", () => {
...
test("family health blocks blocked evidence and degrades aging context", () => {
